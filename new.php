    ...
    <section class="banner">
        ...
        <form method="GET" action="" class="banner__formulario">
            ...
            <button class="w3-btn w3-border w3-round-large" style="background-color:rgb(255, 99, 71, 0.5)" onclick="toggleCategories()">Mostrar Categorias</button>
                ...
                <li><a href="?categoria=Bolsas" class="w3-button w3-border w3-round-large" style="background-color:rgb(255, 99, 71, 0.5)">Bolsas Maternidade</a></li>
            </ul>
    </section>

    <section class="catalogo">
    <h2 class="container__titulo">Nossa Linha de Produtos</h2>
